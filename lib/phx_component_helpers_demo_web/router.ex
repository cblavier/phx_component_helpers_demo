defmodule PhxComponentHelpersDemoWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {PhxComponentHelpersDemoWeb.Layouts, :root}
  ...
  # scope "/api", PhxComponentHelpersDemoWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:phx_component_helpers_demo, :dev_routes) do
